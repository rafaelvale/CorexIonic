...
namespace YouLearn.Infra.Migrations
{
    ...
    [Migration("20181006133241_Setup")]
    partial class Setup
    {
            ...
            modelBuilder.Entity("YouLearn.Domain.Entities.Video", b =>
                {
                    ...
                    b.HasOne("YouLearn.Domain.Entities.Usuario", "UsuarioSugerido")
                        .WithMany()
                        .HasForeignKey("IsUsuario");
                });
